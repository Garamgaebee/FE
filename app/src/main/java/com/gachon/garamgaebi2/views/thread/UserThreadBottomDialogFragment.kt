...
import com.gachon.garamgaebi2.databinding.FragmentUserThreadBottomDialogBinding
...
class UserThreadBottomDialogFragment(val itemClick : (Int) -> Unit) :
    BottomSheetDialogFragment() {
    private val viewModel: ThreadViewModel by activityViewModels()

    lateinit var binding: FragmentUserThreadBottomDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_user_thread_bottom_dialog,
            container,
            false
        )
        return binding.root
